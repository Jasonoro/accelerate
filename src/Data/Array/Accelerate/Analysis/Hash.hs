...
encodePreOpenAcc options encodeAcc pacc =
  ...
  case pacc of
    ...
    SegScan _ d f e a s             -> intHost $(hashQ "SegScan")     <> travD d  <> travF f  <> encodeMaybe travE e <> travA a <> travA s
    SegScan' _ d f e a s            -> intHost $(hashQ "SegScan'")    <> travD d  <> travF f  <>             travE e <> travA a <> travA s
